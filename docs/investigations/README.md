...
| [02 — DumpMe Meterpreter intrusion](case-02-dumpme-meterpreter-intrusion.md) | Interactive attacker: Metasploit payload, internal C2, data access | Draft — pending local validation |
| 03 — Credential-theft scenario (planned) | A lab with lsass access / hashdump activity (e.g. CyberDefenders "Reveal" or 13Cubed Mini Memory CTF) to cover T1003 | Planned |
...
2. `python -m src.cli analyze images/<image>`
