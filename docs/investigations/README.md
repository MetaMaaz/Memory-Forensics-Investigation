...
| [04 — Reveal / StrelaStealer credential theft](case-04-reveal-strelastealer.md) | Phishing → hidden PowerShell → WebDAV `net use` → `rundll32` of remote DLL (no-disk); Thunderbird credential theft | **Complete** — live run 2026-06-11 |
